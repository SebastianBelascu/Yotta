      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg">
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Yotta, 123 Business Avenue, Singapore 123456.</li>
            ...
            <li><strong>Website</strong> refers to Yotta, accessible from [website URL]</li>
