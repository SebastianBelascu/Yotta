-- Create footer table for managing footer content
CREATE TABLE IF NOT EXISTS footer (
  id SERIAL PRIMARY KEY,
  section VARCHAR(50) NOT NULL, -- 'quick_links', 'categories', 'social_media', 'company_info'
  title VARCHAR(255),
  content TEXT,
  link_url VARCHAR(500),
  icon_name VARCHAR(100), -- For social media icons
...
-- Allow authenticated users to manage footer content
